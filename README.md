...
2. Then run "sudo chmod 777 MONITOR.sh && MANAGED.sh"
3. After that you can execute them by running "sudo ./(MANAGED OR MONITOR).sh"
4. It will ask for your password because the script requires sudo permissions.
